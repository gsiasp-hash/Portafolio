...
export default class Proyecto extends Component {
  render() {
    return (
      <div
        className="bg-gray-950  text-white flex flex-col items-center gap-6 p-2 m-5 md:flex-row md:gap-8 rounded-2xl
      border"
      >
        <div>
          <img
        ...
        <div className="flex flex-col text-center md:items-start">
          ...
          <span className="flex items-center gap-2 font-light text-gray-600 dark:text-gray-400">
            <span>No. 4</span>
            <span>·</span>
            <span>2025</span>
          </span>
